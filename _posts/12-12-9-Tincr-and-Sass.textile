...
<p class="inset"><code>config.sass_options = {:debug_info => true}</code></p>

This will create a line before each rule in your css that starts with <code>@media -sass-debug-info{...}</code>
...
!(img-center)/img/enable-source-maps.png(enable source maps)!
